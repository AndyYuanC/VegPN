...
parser.add_argument('--netG', default='Trained_Model/point_netG.pth', help="path to netG (to continue training)")
...
#            num_crop = np.array([[len(np_crop)]])
        ...
        np.savetxt('test-examples/crop_2048_'+str(n)+'.csv', np_inco, fmt = "%f,%f,%f")
